...
<CsInstruments>
	...
	instr 1
		...
		kt times
		kt=kt/600.0
		kj = cos(3.141592654*0.125+kt*2*3.141592654)*(0.5-0.5*cos((4.0-(2.0*(2.0+(1.0-abs(1.0-2.0*kt)))))*3.141592654))
		kjb = sin(kt*2*3.141592654)*(0.5+0.5*sin((2.0-(2.0*(4.0+(2.0-abs(2.0-4.0*kt)))))*3.141592654))
