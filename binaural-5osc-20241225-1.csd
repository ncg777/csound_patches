...
<CsInstruments>
	...
	instr 1
		...
		kt times
		kt=kt/600.0
		kj = (0.5+0.5*cos(3.141592654*0.125+kt*40*3.141592654)*(0.5-0.5*cos((4.0-(2.0*(2.0+(1.0-abs(1.0-2.0*kt)))))*3.141592654)))
		kjb = sin(kt*40*3.141592654)*(0.5+0.5*sin((2.0-(2.0*(4.0+(2.0-abs(2.0-4.0*kt)))))*3.141592654))

		ks lfo 2.0*kj, (p5)*(0.5+0.5*kjb), 1
		ks=ks+1	
...
<CsScore>
	...
	i 1 0 600 65.40639133 0.0666666666666666666667
	e
</CsScore>
</CsoundSynthesizer>
